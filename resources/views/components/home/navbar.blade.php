<div class="navbar bg-base-100 mt-2 flex flex-col sticky top-0 z-10">
    <label
        class="w-full lg:w-[50%] mt-3 input input-bordered relative items-center pe-0 rounded-full hover:scale-110 transition ease-in-out hover:shadow-lg border-none bg-zinc-100"
        id="searchBar">
        <input type="text" placeholder="Search" wire:model="search" wire:keydown.enter="searchVid"
            class="border-3 border-gray-600 w-[90%]" />
